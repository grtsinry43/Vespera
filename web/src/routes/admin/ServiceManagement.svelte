<script lang="ts">
    ...
    async function handleToggleVisibility(service: Service) {
        try {
            await api.services.update(service.id, { is_public: !service.is_public });
            await loadServices();
        } catch (e) {
                            ...
                            >
                                ...
                                <td class="py-4 px-4">
                                    ...
                                    <button
                                        ...
                                        title={overview.service.is_public ? "Click to make private" : "Click to make public"}
                                    >
